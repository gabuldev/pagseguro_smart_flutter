...
public class TransactionsPresenter {
        ...
        .subscribe(
          (ActionResult result) -> {
            ...
            if (
              ...
              mFragment.onPrintError(result.getMessage());
            } else {
  ...
  private String checkMessagePassword(int eventCode) {
    ...
    int value = mUseCase.getEventPaymentData() != null
      ? mUseCase.getEventPaymentData().getAmount()
      : 0;
  ...
  public void abortTransaction() {
    ...
    mSubscribe =
      mUseCase
        ...
        .subscribe(
          o -> mFragment.onAbortedSuccessfully(),
  ...
  public void getLastTransaction() {
    mSubscribe =
      mUseCase
        ...
        .subscribe(
          actionResult ->
            mFragment.onLastTransaction(actionResult.getTransactionCode()),
          throwable -> mFragment.onError(throwable.getMessage())
        );
  }
